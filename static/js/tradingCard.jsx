...
function TradingCardContainer() {
  ...
  return (
    <React.Fragment>
      <AddTradingCard setCards={setCards}/>
      <h2>Trading Cards</h2>
...
function AddTradingCard(props) {
  ...
  function addNewCard() {
    ...
    .then(response => response.json())
    .then(responseJson => {
      // setName (props.setCard(responseJson.cardAdded.name) );
      // setSkill (responseJson.cardAdded.skill);
      console.log(props.cards);
      console.log(responseJson);
      props.setCards(cards => [...cards, responseJson.cardAdded]);
    })
